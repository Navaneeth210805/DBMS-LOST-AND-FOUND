...
const Card = ({ item }) => {
    ...
    return (
        <div className='flex flex-col justify-center bg-transparent border-2 backdrop-blur-3xl border-indigo-800 shadow-md shadow-indigo-500/75 p-4 w-100 h-100 lg:w-116 lg:h-116 rounded-xl cursor-pointer'>
                ...
                <div className="card-content h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-300 p-5 z-0">
                    <div className="mb-2 flex flex-row justify-center">
                        ...
                        <button type="button" onClick={copyEmail}>
                            <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" onClick={copyNumber} width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div className='flex flex-row justify-center'>
                {item.Image ? (
                    <img src={item.Image} alt="Lost item" className="mt-6 w-50 h-32 flex justify-center cursor-pointer" onClick={handleImageClick} />
                ) : (
