        ...
        <>
            ...
            <div className='flex flex-col justify-center items-center h-screen mt-10'>
                ...
                <div className='text-white text-3xl m-10'>
                    ...
                    <div>Go to the <Link className="text-indigo-300 transition duration-0 underline underline-offset-2 hover:duration-300 hover:underline hover:underline-offset-4 hover:decoration-indigo-300" href={`/lostforms/${formsID}`}>Lost Forms</Link> to upload it.</div>
                ...
                <div className='text-white text-3xl m-10'>
                    ...
                    <div>Go to the <Link className="text-indigo-300 transition duration-0 underline underline-offset-2 hover:duration-300 hover:underline hover:underline-offset-4 hover:decoration-indigo-300" href={`/foundforms/${formsID}`}>Found Forms</Link> to upload it.</div>
                    <div className='text-xl'>
                        Provide details such as:
                        <ul className='list-disc'>
                            <li>Item Type</li>
                ...
                <Link className='mb-6' href={`/home/${params.formsID}`}>
