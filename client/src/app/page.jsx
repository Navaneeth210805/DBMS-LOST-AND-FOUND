...
const LoadingScreen = () => {
  ...
  return (
    <div className="loading-screen flex flex-col items-center justify-center p-10 m-10">
      {showFirstText && (
        <div className="falling-texts space-y-4 text-4xl text-indigo-500 font-bold ">
      ...
      {showThirdText && (
        <div className="text-white font-bold md:flex-row lg:flex-row sm:flex-col items-center justify-center">
          <Link href="/signup">
            <button className="falling-texts2 w-[300px] p-2 bg-indigo-600 text-white rounded-lg hover:ring-4 hover:ring-offset-1 hover:bg-white hover:text-black m-6">
              Sign Up
            </button>
          </Link>
          <Link href="/login">
